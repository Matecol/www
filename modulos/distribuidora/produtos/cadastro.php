					...
					<div id="conteudo" class="col-xs-12 col-md-10">
								...
								<form role="form">
									<div class="row">
									    ...
									    <div class="form-group col-md-12">
										    ...
										    <input type="text" class="form-control" id="nome" name="nome" autocomplete="off" maxlength="40" value="<?= $nome ?>" autofocus <?php permissao(); ?> required>
									    </div>
										<!-- CODIGO REFERENCIA -->
									    <div class="form-group col-md-3">
										    <label for="codigo_referencia">Código de Referencia: </label>
										    <input type="text" class="form-control" id="codigo_referencia" name="codigo_referencia" autocomplete="off" maxlength="20" value="<?= $codigo_referencia ?>" <?php permissao(); ?> >
									    </div>
										<!-- CODIGO FABRICA -->
									    <div class="form-group col-md-3">
										    <label for="codigo_fabrica">Código da Fábrica: </label>
										    <input type="text" class="form-control" id="codigo_fabrica" name="codigo_fabrica" autocomplete="off" maxlength="20" value="<?= $codigo_fabrica ?>" <?php permissao(); ?> >
									    </div>
										<!-- CODIGO BARRAS -->
									    <div class="form-group col-md-3">
										    <label for="codigo_barras">Código de Barras: </label>
										    <input type="text" class="form-control" id="codigo_barras" name="codigo_barras" autocomplete="off" maxlength="20" value="<?= $codigo_barras ?>" <?php permissao(); ?> >
									    </div>
										<!-- GRUPO -->
										...
										<!-- UNIDADE DE MEDIDA -->
                                         <div class="form-group col-md-3">
											...
											<select class="form-control" id="unidade_medida" name="unidade_medida" <?php permissao(); ?>>
											<option value="1" <?= ($unidade_medida == "1") ? "selected" : "" ?>>PC</option>
											<option value="2" <?= ($unidade_medida == "2") ? "selected" : "" ?>>LT</option>
											<option value="3" <?= ($unidade_medida == "3") ? "selected" : "" ?>>XX</option>
											<option value="4" <?= ($unidade_medida == "4") ? "selected" : "" ?>>XX</option>
											<option value="5" <?= ($unidade_medida == "5") ? "selected" : "" ?>>XX</option>
											</select>
										</div>
										<!-- PRECO DE CUSTO -->
									    <div class="form-group col-md-2">
									    ...
									    <div class="form-group col-md-2">
										    ...
										    <input type="text" step="any" inputmode="numeric" pattern="[0-9]*" class="form-control" id="preco_venda" name="preco_venda" autocomplete="off" value="<?= $preco_venda ?>" <?php permissao(); ?>>
									    </div>
										<!-- SITUACAO -->
							    		<div class="form-group col-md-2">
						...
						<div class="btn-control-bar">
							<div class="panel-heading">
								...
								<button class="btn btn-danger mob-btn-block" style="<?php if ($_action == "inclusao") { echo "display: none"; } ?>" data-toggle="modal" data-target="#modal" onclick="dialogYesNo('esubmit()', null, 'Excluir Produto', 'Deseja excluir este Produto ?', 'trash');" <?php if ($perm_excluir != 'S') { echo "disabled"; } ?>>
