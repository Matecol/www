<?php
		...
		$perm = testarPermissao('INCLUIR CADASTRO DE GERENCIADOR');
?>
<!DOCTYPE html>
<html>
	<head>
							...
							<div class="panel-body">
								...
								<table class="table table-hover table-striped tabela-registro" id="tabela">
									...
									<?php
										...
										if (empty($pesquisa)) {
											$sql = "select * from gerenciador order by id limit " . $limite . " offset " . (($pagina-1)*$limite);
										} else {
											$sql = "select * from gerenciador where id like '" . $pesquisa . "%' order by id limit " . $limite . " offset " . (($pagina-1)*$limite);
										}
										...
										// Paginaçao
										if (empty($pesquisa)) {
											$sql = "select count(*) as num from gerenciador";
										} else {
											$sql = "select count(*) as num from gerenciador where id like '" . $pesquisa . "%';";
										}
